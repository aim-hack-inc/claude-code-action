...
## Fork Changes (aim-hack-inc/claude-code-action@beta)
...
- **Updated Base Action**: Uses `aim-hack-inc/claude-code-base-action@beta` which includes OAuth credential handling
